...
<body class="home-body">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4  md-4" style="width: 20rem;">
                <div class="card border-info">
                    ...
                    <div class="list-group">
                        ...
                        <a href="/editProfile" class="list-group-item list-group-item-action">Edit Profile</a>
            ...
            <!-- <div class="col-lg-8 md-8">
                <div class="card  border-info" id="profile">
                    <div class="row g-0">
                        <div>
                            <div class="card-body">
